...
public class MainActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextPassword.setText(mPrefs.getString("password", getString(R.string.default_pwd)));
        mEditTextUsername.setText(mPrefs.getString("username", getString(R.string.default_id)));
