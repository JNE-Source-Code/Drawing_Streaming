...
package com.example.rtsp_test.streaming;

import java.io.IOException;
import java.net.InetAddress;
import java.net.UnknownHostException;

import com.example.rtsp_test.streaming.audio.AACStream;
import com.example.rtsp_test.streaming.audio.AMRNBStream;
import com.example.rtsp_test.streaming.audio.AudioQuality;
import com.example.rtsp_test.streaming.audio.AudioStream;
import com.example.rtsp_test.streaming.exceptions.CameraInUseException;
import com.example.rtsp_test.streaming.exceptions.ConfNotSupportedException;
import com.example.rtsp_test.streaming.exceptions.InvalidSurfaceException;
import com.example.rtsp_test.streaming.exceptions.StorageUnavailableException;
import com.example.rtsp_test.streaming.gl.SurfaceView;
import com.example.rtsp_test.streaming.rtsp.RtspClient;
import com.example.rtsp_test.streaming.video.H263Stream;
import com.example.rtsp_test.streaming.video.H264Stream;
import com.example.rtsp_test.streaming.video.VideoQuality;
import com.example.rtsp_test.streaming.video.VideoStream;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("com.example.rtsp_test.streaming.Session");
		thread.start();
	...
	public void addVideoTrack(H263Stream h263Stream) {
	}

	public void addAudioTrack(AMRNBStream amrnbStream) {
	}
	...
	/** You probably don't need to use that directly, use the {@link SessionBuilder}.
	 * @param track*/
	void addVideoTrack(H264Stream track) {
		removeVideoTrack();
		mVideoStream = track;
	}
